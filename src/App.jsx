...
// Adicionei ?v=2 para forçar o navegador a recarregar as imagens caso estejam em cache antigo
const FUNDO_MAP = {
  '1 MÊS': {
    ...
    <div className="min-h-screen bg-gray-100 font-sans flex flex-col md:flex-row">
      ...
      <div className="no-print w-full md:w-1/3 lg:w-1/4 bg-white p-6 shadow-lg overflow-y-auto z-10 border-r border-gray-200 h-screen sticky top-0 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="mb-8">
            {/* ATENÇÃO: Ao colar seu SVG abaixo, NÃO inclua a linha "<?xml version...?>"
                Copie apenas de <svg ...> até </svg>
            */}
            <svg width="180" height="50" viewBox="0 0 180 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <text x="0" y="35" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="32" fill="#0077c8" style={{fontFamily: "'Bebas Neue', sans-serif"}}>
                Korpus
              </text>
              <text x="95" y="35" fontFamily="Arial, sans-serif" fontSize="12" fill="#f58220" style={{letterSpacing: '2px'}}>
                ACADEMIA
              </text>
              <path d="M140 25 A 15 15 0 0 1 155 40" stroke="#f58220" strokeWidth="4" fill="none" />
              <path d="M155 40 L 150 35 M 155 40 L 160 35" stroke="#f58220" strokeWidth="4" />
            </svg>
          </div>
