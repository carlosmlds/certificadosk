...
const FUNDO_MAP = {
  '1 MÊS': {
    ouro: '/img_fundos/fundo_1mes.jpg',
    box_k: '/img_fundos/fundo_1mes_boxk.jpg'
  },
  '3 MESES': {
    ouro: '/img_fundos/fundo_3meses.jpg',
    box_k: '/img_fundos/fundo_3meses_boxk.jpg'
  },
  '6 MESES': {
    ouro: '/img_fundos/fundo_6meses.jpg',
    box_k: '/img_fundos/fundo_6meses_boxk.jpg'
  },
  '1 ANO': {
    ouro: '/img_fundos/fundo_1ano.jpg',
    box_k: '/img_fundos/fundo_1ano_boxk.jpg'
  },
};
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans flex flex-col md:flex-row">
      ...
      <div className="no-print w-full md:w-1/3 lg:w-1/4 bg-white p-6 shadow-lg overflow-y-auto z-10 border-r border-gray-200 h-screen sticky top-0">
        ...
        {/* LOGO SVG NO LUGAR DO TÍTULO "EDITOR" */}
        <div className="mb-8">
           {/* COLOQUE O CÓDIGO DA SUA LOGO AQUI */}
          ...
          {fundoCertificado ? (
            <img 
              ...
              onError={(e) => {
                ...
                e.target.src = "https://via.placeholder.com/1123x794?text=Imagem+de+Fundo+N%C3%A3o+Encontrada";
              }}
            />
          ) : (
